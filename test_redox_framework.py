...
def test_load_config():
    ...
    try:
        ...
        config_file = Path("config_redox.json")
        ...
        print(f"  ✓ Loaded redox parameters from config_redox.json")
...
def main():
    ...
    if all(results):
        ...
        print("\nNext steps:")
        print("  1. Edit config_redox.json with your redox-active molecules")
        print("  2. Run: python run_voltage_sweep.py ...")
        return 0
    else:
